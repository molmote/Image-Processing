...
C:\Users\guest\AppData\Local
	*/
	/*char acAppData[MAX_PATH];
	SHGetSpecialFolderPathA(NULL, acAppData, CSIDL_APPDATA, FALSE);


	char acAppData2[MAX_PATH];
	SHGetSpecialFolderPathA(NULL, acAppData2, CSIDL_APPDATA, FALSE);*/
	...
	char * Ini = "imgui.ini";
	char * Log = "imgui_log.txt";



	/*strcat(acAppData, Ini);
	strcat(acAppData2, Log);*/
